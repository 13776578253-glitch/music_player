...
-   **接口地址**: `/songslists/:user_id/:playlsit_id`
...
-   **请求体 (JSON)**:
    ...
    ```
    {
        "user_id": "123456",
        "playlist_id": "50",
        "action": "collect"  // 可选值: "collect" (收藏), "uncollect" (取消)
    }
    ```
